...
const ManageBanner = () => {
    ...
    const fetchMedicines = async () => {
        try {
            const response = await axios.get("https://assignment-12-server-sable-six.vercel.app/medichin-benner");
    ...
    const handleToggleBanner = async (id) => {
        try {
            await axios.put(`https://assignment-12-server-sable-six.vercel.app/api/medicines/${id}/toggle-feature`);
    ...
    return (
        <>
            <Helmet>
                <title>
                    Medico |Manage Banner Advertise
                </title>
            </Helmet>  <div className="p-6 bg-gray-100 min-h-screen">
